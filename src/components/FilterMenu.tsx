...
export const FilterMenu = () => {
  ...
  return (
    <nav className="sticky top-16 z-20 bg-white w-screen p-2 capitalize flex gap-2 overflow-x-scroll sm:overflow-auto justify-between sm:justify-center items-center">
